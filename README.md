...
**Technicademy** היא אפליקציית Android לאקדמיית כדורגל – הרשמה לחוגים, מערכת שעות, לוח חגים, מודעות וניהול פרופיל משתמש.
...
- **הרשמה ותשלום** – טופס הרשמה לחוג, בחירת יום אימון, סיכום ומחיר (100 ₪ לחוג).
...
- **מחיר אחיד** – 100 ₪ לחוג (קבוע במערכת, מוצג בהרשמה ובמסך התשלום).
...
ניתן להוסיף צילומי מסך: דף הבית, התחברות, מערכת שעות, פרופיל.
